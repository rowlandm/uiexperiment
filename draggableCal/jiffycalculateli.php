...
<script>
	...
	function refreshCalendar(showNumDays){
  		...
  		$.ajax({
			type: "POST",
				...
				*/ 
				...
				Jiffy.measure("over Calendar > li droppable ", "refreshCalendar");
  	...
  	function refreshCalendarEvents(){
        ...
        Jiffy.measure("remove lis ", "refreshCalendarEvents");
  		...
  		$.ajax({
			type: "POST",
		   	...
		   	success: function(msg){
				...
				Jiffy.measure("finish setting up the events", "refreshCalendarEvents");
  	...
  	function setSelectedElementsToSave (action,collection,name,inputType,inputCode,inputDetails){
  		...
  		Jiffy.mark("setSelectedElementsToSave");
		...
		Jiffy.measure("set li's to saved","setSelectedElementsToSave");
		...
		if ((action == 'moved') || (action == 'add')){
  		...
  		Jiffy.measure("end","setSelectedElementsToSave");
