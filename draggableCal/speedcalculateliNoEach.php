...
<script>
	...
	function setFunctionality(){
				...
				var setFunctionalityStart = new Date ();
				$('#speed').append('setFunctionalityStart:' + setFunctionalityStart.getSeconds() + '.' + setFunctionalityStart.getMilliseconds() +  '<br>');
				...
				var setFunctionalityMiddle = new Date ();
				$('#speed').append('setFunctionalityMiddle:' + setFunctionalityMiddle.getSeconds() + '.' + setFunctionalityMiddle.getMilliseconds() +  '<br>');		
			...
			var setFunctionalityEnd = new Date ();
				$('#speed').append('setFunctionalityEnd:' + setFunctionalityEnd.getSeconds() + '.' + setFunctionalityEnd.getMilliseconds() +  '<hr>');
	...
	function refreshCalendar(showNumDays){
		...
		*/
		...
		$('#speed').append('refreshCalendar:' + speedStart.getSeconds() + '.' + speedStart.getMilliseconds() +  '<br>');
  		...
  		$.ajax({
			type: "POST",
		   	...
		   	success: function(msg){
		   		...
		   		var successReturnInitial = new Date ();
				$('#speed').append('startsuccessajaxReturnInitial:' + successReturnInitial.getSeconds() + '.' + successReturnInitial.getMilliseconds() +  '<br>');
				...
				*/ 
		   		...
		   		var successEndReturnInitial = new Date ();
				$('#speed').append('successEndReturnInitial:' + successEndReturnInitial.getSeconds() + '.' + successEndReturnInitial.getMilliseconds() +  '<br>');
  	...
  	function refreshCalendarEvents(){
		...
		var speedCalStart = new Date ();
		$('#speed').append('refreshCalendarEvents:' +  speedCalStart.getSeconds() + '.' + speedCalStart.getMilliseconds() +  '<br>');
        ...
        var speedRemoveCalsAndLisStart = new Date ();
		$('#speed').append('speedRemoveCalsAndLisStart:' +  speedRemoveCalsAndLisStart.getSeconds() + '.' + speedRemoveCalsAndLisStart.getMilliseconds() +  '<br>');
  		...
  		$.ajax({
			type: "POST",
		   	...
		   	success: function(msg){
		        ...
		        var successAjax = new Date ();
				$('#speed').append('startsuccessAjaxCalEvents + json_parse start:' +  successAjax.getSeconds() + '.' + successAjax.getMilliseconds() +  '<br>');


		    	
 		    	var myObject = json_parse(msg);
 		    	
		        var successAjaxjsonEnd = new Date ();
				$('#speed').append('successAjaxjsonEnd + json_parse end:' +  successAjaxjsonEnd.getSeconds() + '.' + successAjaxjsonEnd.getMilliseconds() +  '<br>');
 		    	
 		    	
 		    	$('#overCalendar').append('<span>');
 		    	
		        var overalendarappend = new Date ();
				$('#speed').append('overalendarappend:' +  overalendarappend.getSeconds() + '.' + overalendarappend.getMilliseconds() +  '<br>');
 		    	
				for (key in myObject){
					
					
					
					var startLoop = new Date ();
					$('#speed').append('--------------startLoop:' +  startLoop.getSeconds() + '.' + startLoop.getMilliseconds() +  '<br>');
					...
					var beforeliSelectedLoop = new Date ();
					$('#speed').append('--------------beforeliSelectedLoop:' +  beforeliSelectedLoop.getSeconds() + '.' + beforeliSelectedLoop.getMilliseconds() +  '<br>');
					...
					var afterliSelectedLoop = new Date ();
					$('#speed').append('--------------afterliSelectedLoop:' +  afterliSelectedLoop.getSeconds() + '.' + afterliSelectedLoop.getMilliseconds() +  '<br>');
					...
					var aftersetSelectedElementsToSave = new Date ();
					$('#speed').append('--------------aftersetSelectedElementsToSaveLoop:' +  aftersetSelectedElementsToSave.getSeconds() + '.' + aftersetSelectedElementsToSave.getMilliseconds() +  '<br>');

					
				}	

				
				var speedEnd = new Date();
		   		$('#speed').append('End Refresh Cal Events:' + speedEnd.getSeconds() + '.' + speedEnd.getMilliseconds() +  '<br>');
  	...
  	function setSelectedElementsToSave (action,collection,name,inputType,inputCode,inputDetails){
  		...
  		var startsetSelectedElementsToSave = new Date ();
		$('#speed').append('--------------------------startsetSelectedElementsToSave:' +  startsetSelectedElementsToSave.getSeconds() + '.' + startsetSelectedElementsToSave.getMilliseconds() +  '<br>');
        ...
        collection.each(function() {
  		...
  		var AfterColelctionssetSelectedElementsToSave = new Date ();
		$('#speed').append('--------------------------AfterColelctionssetSelectedElementsToSave:' +  AfterColelctionssetSelectedElementsToSave.getSeconds() + '.' + AfterColelctionssetSelectedElementsToSave.getMilliseconds() +  '<br>');
		...
		$('#' + parent + txtStart + 'data').hide();
  		...
  		var AfterAppendNewDiv = new Date ();
		$('#speed').append('--------------------------AfterAppendNewDiv:' +  AfterAppendNewDiv.getSeconds() + '.' + AfterAppendNewDiv.getMilliseconds() +  '<br>');
		...
		function(action, el, pos) {
  		...
  		var AfterSetupJqueryNewDiv = new Date ();
		$('#speed').append('--------------------------AfterSetupJqueryNewDiv:' +  AfterSetupJqueryNewDiv.getSeconds() + '.' + AfterSetupJqueryNewDiv.getMilliseconds() +  '<br>');
		...
		if ((action == 'moved') || (action == 'add')){
  			...
  			var actionMovedOrAdd = new Date ();
			$('#speed').append('--------------------------actionMovedOrAdd:' +  actionMovedOrAdd.getSeconds() + '.' + actionMovedOrAdd.getMilliseconds() +  '<br>');
				...
				type: "POST",
			   	...
			   	success: function(msg){
					...
					if (pos >= 0)
					{
	  				...
	  				var finishAjaxMovedOrAdd = new Date ();
					$('#speed').append('--------------------------finishAjaxMovedOrAdd:' +  finishAjaxMovedOrAdd.getSeconds() + '.' + finishAjaxMovedOrAdd.getMilliseconds() +  '<br>');
			...
			$('#' + parent + txtStart).css("background","green");
		  				...
		  				var finishNewDiv = new Date ();
					$('#speed').append('--------------------------finishNewDiv:' +  finishNewDiv.getSeconds() + '.' + finishNewDiv.getMilliseconds() +  '<br>');
  	...
  	*/
  	...
  	$(document).ready(function(){
		...
		$('#speed').ajaxStart(function(){
			var startAkaax = new Date ();
			$('#speed').append('startAjax:' +  startAkaax.getSeconds() + '.' + startAkaax.getMilliseconds() +  '<br>');
		});
		
		var speedStart = new Date ();
		$('#speed').append('initialLoad:' + speedStart.getSeconds() + ':' + speedStart.getMilliseconds() +  '<br>');
